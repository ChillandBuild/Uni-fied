...
import { Save, RefreshCcw, CheckCircle, XCircle, Eye } from 'lucide-react';
              ...
              <tr key={b.batch_number} className="hover:bg-[#f9fafb]">
                ...
                <td className="px-5 py-3.5">
                  <div className="flex items-center gap-1.5">
                    <button onClick={() => handleSelectBatch(b)} className="p-1.5 rounded-lg hover:bg-[#f3e8ff] text-[#7c3aed]" title="View">
                      <Eye size={14}/>
                    </button>
                    {b.status !== 'Completed' && <>

import {
  require_react_dom
} from "./chunk-EGKWE7B7.js";
import {
  require_jsx_runtime
} from "./chunk-AQIJC462.js";
import {
  require_react
} from "./chunk-W5EIT22D.js";
import {
  __commonJS,
  __export,
  __privateAdd,
...
var require_use_sync_external_store_shim_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    ...
    (function() {
      ...
      var React79 = require_react(), objectIs = "function" === typeof Object.is ? Object.is : is, useState35 = React79.useState, useEffect40 = React79.useEffect, useLayoutEffect6 = React79.useLayoutEffect, useDebugValue = React79.useDebugValue, didWarnOld18Alpha = false, didWarnUncachedGetSnapshot = false, shim = "undefined" === typeof window || "undefined" === typeof window.document || "undefined" === typeof window.document.createElement ? useSyncExternalStore$1 : useSyncExternalStore$2;
...
function CheckboxProvider(props) {
  ...
  const [control, setControl] = React43.useState(null);
  const [bubbleInput, setBubbleInput] = React43.useState(null);
...
var CheckboxTrigger = React43.forwardRef(
...
var PopperAnchor = React46.forwardRef(
  (props, forwardedRef) => {
    ...
    const composedRefs = useComposedRefs(forwardedRef, ref);
    const anchorRef = React46.useRef(null);
    React46.useEffect(() => {
...
var NAME6 = "Label";
var Label5 = React55.forwardRef((props, forwardedRef) => {
...
var Menubar = React56.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeMenubar,
      value: valueProp,
    ...
    const [currentTabStopId, setCurrentTabStopId] = React56.useState(null);
    return (0, import_jsx_runtime33.jsx)(
      MenubarContextProvider,
      {
        scope: __scopeMenubar,
        value,
        onMenuOpen: React56.useCallback(
          (value2) => {
            setValue(value2);
        ...
        onMenuClose: React56.useCallback(() => setValue(""), [setValue]),
        onMenuToggle: React56.useCallback(
          (value2) => {
        ...
        dir: direction,
        loop,
        children: (0, import_jsx_runtime33.jsx)(Collection4.Provider, { scope: __scopeMenubar, children: (0, import_jsx_runtime33.jsx)(Collection4.Slot, { scope: __scopeMenubar, children: (0, import_jsx_runtime33.jsx)(
          Root10,
          {
            asChild: true,
            ...rovingFocusGroupScope,
            ...
            children: (0, import_jsx_runtime33.jsx)(Primitive.div, { role: "menubar", ...menubarProps, ref: forwardedRef })
          }
        ) }) })
      }
    );
...
var MenubarMenu = (props) => {
  ...
  const wasKeyboardTriggerOpenRef = React56.useRef(false);
...
var MenubarTrigger = React56.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime33.jsx)(Collection4.ItemSlot, { scope: __scopeMenubar, value: menuContext.value, disabled, children: (0, import_jsx_runtime33.jsx)(
      Item2,
      {
        asChild: true,
        ...rovingFocusGroupScope,
        ...
        children: (0, import_jsx_runtime33.jsx)(Anchor2, { asChild: true, ...menuScope, children: (0, import_jsx_runtime33.jsx)(
          Primitive.button,
          {
            type: "button",
            role: "menuitem",
...
var MenubarPortal = (props) => {
  ...
  const menuScope = useMenuScope3(__scopeMenubar);
  return (0, import_jsx_runtime33.jsx)(Portal3, { ...menuScope, ...portalProps });
};
MenubarPortal.displayName = PORTAL_NAME8;
var CONTENT_NAME10 = "MenubarContent";
var MenubarContent = React56.forwardRef(
  (props, forwardedRef) => {
...
var MenubarGroup = React56.forwardRef(
  (props, forwardedRef) => {
...
var MenubarLabel = React56.forwardRef(
  (props, forwardedRef) => {
...
var MenubarItem = React56.forwardRef(
  (props, forwardedRef) => {
    const { __scopeMenubar, ...itemProps } = props;
    const menuScope = useMenuScope3(__scopeMenubar);
    return (0, import_jsx_runtime33.jsx)(Item22, { ...menuScope, ...itemProps, ref: forwardedRef });
  }
);
MenubarItem.displayName = ITEM_NAME6;
var CHECKBOX_ITEM_NAME4 = "MenubarCheckboxItem";
var MenubarCheckboxItem = React56.forwardRef(
  (props, forwardedRef) => {
...
var MenubarRadioGroup = React56.forwardRef(
  (props, forwardedRef) => {
...
var MenubarRadioItem = React56.forwardRef(
  (props, forwardedRef) => {
...
var MenubarItemIndicator = React56.forwardRef((props, forwardedRef) => {
...
var MenubarSeparator = React56.forwardRef(
  (props, forwardedRef) => {
...
var MenubarArrow = React56.forwardRef(
  (props, forwardedRef) => {
...
var MenubarSubTrigger = React56.forwardRef(
  (props, forwardedRef) => {
...
var MenubarSubContent = React56.forwardRef(
  (props, forwardedRef) => {
...
var NavigationMenu = React57.forwardRef(
  (props, forwardedRef) => {
    const {
    ...
    const [navigationMenu, setNavigationMenu] = React57.useState(null);
    ...
    const startCloseTimer = React57.useCallback(() => {
...
var NavigationMenuSub = React57.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeNavigationMenu,
      value: valueProp,
...
var NavigationMenuProvider = (props) => {
  ...
  const [viewport, setViewport] = React57.useState(null);
  const [viewportContent, setViewportContent] = React57.useState(/* @__PURE__ */ new Map());
  const [indicatorTrack, setIndicatorTrack] = React57.useState(null);
  return (0, import_jsx_runtime34.jsx)(
    NavigationMenuProviderImpl,
    {
      ...
      onViewportContentChange: React57.useCallback((contentValue, contentData) => {
        setViewportContent((prevContent) => {
          prevContent.set(contentValue, contentData);
          return new Map(prevContent);
        });
      }, []),
      onViewportContentRemove: React57.useCallback((contentValue) => {
        setViewportContent((prevContent) => {
...
var NavigationMenuList = React57.forwardRef(
  (props, forwardedRef) => {
...
var NavigationMenuItem = React57.forwardRef(
  (props, forwardedRef) => {
    ...
    const focusProxyRef = React57.useRef(null);
    const restoreContentTabOrderRef = React57.useRef(() => {
    });
    const wasEscapeCloseRef = React57.useRef(false);
    const handleContentEntry = React57.useCallback((side = "start") => {
    ...
    const handleContentExit = React57.useCallback(() => {
      if (contentRef.current) {
        const candidates = getTabbableCandidates2(contentRef.current);
...
var NavigationMenuTrigger = React57.forwardRef((props, forwardedRef) => {
  ...
  const wasClickCloseRef = React57.useRef(false);
...
var NavigationMenuLink = React57.forwardRef(
  (props, forwardedRef) => {
...
var NavigationMenuIndicator = React57.forwardRef((props, forwardedRef) => {
...
var NavigationMenuIndicatorImpl = React57.forwardRef((props, forwardedRef) => {
  ...
  const [activeTrigger, setActiveTrigger] = React57.useState(
    null
  );
  const [position, setPosition] = React57.useState(null);
...
var NavigationMenuContent = React57.forwardRef((props, forwardedRef) => {
  const { forceMount, ...contentProps } = props;
...
var ViewportContentMounter = React57.forwardRef((props, forwardedRef) => {
  const context = useNavigationMenuContext(CONTENT_NAME11, props.__scopeNavigationMenu);
...
var NavigationMenuContentImpl = React57.forwardRef((props, forwardedRef) => {
  const {
    __scopeNavigationMenu,
    value,
    triggerRef,
  ...
  const getItems = useCollection5(__scopeNavigationMenu);
  const prevMotionAttributeRef = React57.useRef(null);
  ...
  const motionAttribute = React57.useMemo(() => {
    const items = getItems();
...
var NavigationMenuViewport = React57.forwardRef((props, forwardedRef) => {
...
var NavigationMenuViewportImpl = React57.forwardRef((props, forwardedRef) => {
  ...
  const [size4, setSize] = React57.useState(null);
...
var FocusGroup = React57.forwardRef(
  (props, forwardedRef) => {
...
var FocusGroupItem = React57.forwardRef(
  (props, forwardedRef) => {
    const { __scopeNavigationMenu, ...groupProps } = props;
...
var OneTimePasswordField = React58.forwardRef(
  function OneTimePasswordFieldImpl({
    ...
    const sanitizeValue = React58.useCallback(
      (value2) => {
    ...
    const controlledValue = React58.useMemo(() => {
    ...
    const validationTypeRef = React58.useRef(validation);
    React58.useEffect(() => {
      var _a3;
      if (!validation) {
        return;
    ...
    const hiddenInputRef = React58.useRef(null);
    const userActionRef = React58.useRef(null);
    ...
    const locateForm = React58.useCallback(() => {
      var _a3;
      let formElement;
      if (form) {
    ...
    const attemptSubmit = React58.useCallback(() => {
    ...
    const valueRef = React58.useRef(currentValue);
    ...
    return (0, import_jsx_runtime35.jsx)(
      OneTimePasswordFieldContext,
      {
        ...
        isHydrated,
        sanitizeValue,
        children: (0, import_jsx_runtime35.jsx)(Collection6.Provider, { scope: __scopeOneTimePasswordField, state: collectionState, children: (0, import_jsx_runtime35.jsx)(Collection6.Slot, { scope: __scopeOneTimePasswordField, children: (0, import_jsx_runtime35.jsx)(
          Root10,
          {
            asChild: true,
            ...rovingFocusGroupScope,
...
var OneTimePasswordFieldHiddenInput = React58.forwardRef(function OneTimePasswordFieldHiddenInput2({ __scopeOneTimePasswordField, ...props }, forwardedRef) {
...
var OneTimePasswordFieldInput = React58.forwardRef(function OneTimePasswordFieldInput2({
  __scopeOneTimePasswordField,
  onInvalidChange,
  index: indexProp,
  ...props
  ...
  const [element, setElement] = React58.useState(null);
  ...
  const keyboardActionTimeoutRef = React58.useRef(null);
  React58.useEffect(() => {
    return () => {
  ...
  return (0, import_jsx_runtime35.jsx)(Collection6.ItemSlot, { scope: __scopeOneTimePasswordField, children: (0, import_jsx_runtime35.jsx)(
    Item2,
    {
      ...rovingFocusGroupScope,
      asChild: true,
...
var PasswordToggleField = ({
  ...
  const [inputIdState, setInputIdState] = React59.useState(defaultInputId);
  const inputId = inputIdState ?? defaultInputId;
  const syncInputId = React59.useCallback(
  ...
  const focusState = React59.useRef(INITIAL_FOCUS_STATE);
...
var PasswordToggleFieldInput = React59.forwardRef(
  ({
    __scopePasswordToggleField,
...
var PasswordToggleFieldToggle = React59.forwardRef(
  ({
    __scopePasswordToggleField,
    onClick,
    onPointerDown,
    ...
    const [internalAriaLabel, setInternalAriaLabel] = React59.useState(void 0);
    const elementRef = React59.useRef(null);
...
var PasswordToggleFieldIcon = React59.forwardRef(
  ({
    __scopePasswordToggleField,
    // @ts-expect-error
    children,
    ...
    return (0, import_jsx_runtime36.jsx)(Primitive.svg, { ...domProps, ref: forwardedRef, "aria-hidden": true, asChild: true, children: visible ? visibleIcon : hiddenIcon });
  }
);
...
function createSlot6(ownerName) {
  ...
  const Slot22 = React60.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    ...
    if (slottable) {
      ...
      const newChildren = childrenArray.map((child) => {
        if (child === slottable) {
          if (React60.Children.count(newElement) > 1) return React60.Children.only(null);
          return React60.isValidElement(newElement) ? newElement.props.children : null;
        } else {
          return child;
        }
      });
      return (0, import_jsx_runtime37.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React60.isValidElement(newElement) ? React60.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function isSlottable6(child) {
  return React60.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER6;
}
...
var Popover = (props) => {
  ...
  return (0, import_jsx_runtime38.jsx)(Root25, { ...popperScope, children: (0, import_jsx_runtime38.jsx)(
    PopoverProvider,
    {
...
var PopoverAnchor = React61.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime38.jsx)(Anchor, { ...popperScope, ...anchorProps, ref: forwardedRef });
  }
);
...
var PopoverTrigger = React61.forwardRef(
  (props, forwardedRef) => {
    ...
    const popperScope = usePopperScope3(__scopePopover);
    const composedTriggerRef = useComposedRefs(forwardedRef, context.triggerRef);
    const trigger = (0, import_jsx_runtime38.jsx)(
      Primitive.button,
      {
        type: "button",
        "aria-haspopup": "dialog",
    ...
    return context.hasCustomAnchor ? trigger : (0, import_jsx_runtime38.jsx)(Anchor, { asChild: true, ...popperScope, children: trigger });
  }
);
...
var PopoverPortal = (props) => {
  ...
  return (0, import_jsx_runtime38.jsx)(PortalProvider4, { scope: __scopePopover, forceMount, children: (0, import_jsx_runtime38.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime38.jsx)(Portal, { asChild: true, container, children }) }) });
};
...
var PopoverContent = React61.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime38.jsx)(Presence, { present: forceMount || context.open, children: context.modal ? (0, import_jsx_runtime38.jsx)(PopoverContentModal, { ...contentProps, ref: forwardedRef }) : (0, import_jsx_runtime38.jsx)(PopoverContentNonModal, { ...contentProps, ref: forwardedRef }) });
  }
);
...
var PopoverContentModal = React61.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime38.jsx)(Combination_default, { as: Slot9, allowPinchZoom: true, children: (0, import_jsx_runtime38.jsx)(
      PopoverContentImpl,
      {
        ...props,
        ref: composedRefs,
...
var PopoverArrow = React61.forwardRef(
  (props, forwardedRef) => {
    ...
    const popperScope = usePopperScope3(__scopePopover);
    return (0, import_jsx_runtime38.jsx)(Arrow2, { ...popperScope, ...arrowProps, ref: forwardedRef });
  }
);
...
var Progress = React62.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeProgress,
    ...
    return (0, import_jsx_runtime39.jsx)(ProgressProvider, { scope: __scopeProgress, value, max: max2, children: (0, import_jsx_runtime39.jsx)(
      Primitive.div,
      {
        "aria-valuemax": max2,
        "aria-valuemin": 0,
...
var ProgressIndicator = React62.forwardRef(
  (props, forwardedRef) => {
...
var Radio = React63.forwardRef(
  (props, forwardedRef) => {
    ...
    const [button, setButton] = React63.useState(null);
    ...
    return (0, import_jsx_runtime40.jsxs)(RadioProvider, { scope: __scopeRadio, checked, disabled, children: [
...
var RadioIndicator = React63.forwardRef(
  (props, forwardedRef) => {
    const { __scopeRadio, forceMount, ...indicatorProps } = props;
    const context = useRadioContext(INDICATOR_NAME7, __scopeRadio);
    return (0, import_jsx_runtime40.jsx)(Presence, { present: forceMount || context.checked, children: (0, import_jsx_runtime40.jsx)(
      Primitive.span,
      {
...
var RadioBubbleInput = React63.forwardRef(
  ({
    __scopeRadio,
    control,
    checked,
...
var RadioGroupIndicator = React210.forwardRef(
  (props, forwardedRef) => {
    ...
    const radioScope = useRadioScope(__scopeRadioGroup);
    return (0, import_jsx_runtime41.jsx)(RadioIndicator, { ...radioScope, ...indicatorProps, ref: forwardedRef });
  }
);
    ...
    return (0, import_jsx_runtime42.jsxs)(import_jsx_runtime42.Fragment, { children: [
      ...
      (0, import_jsx_runtime42.jsx)(
        Primitive.div,
        {
          ...
          children: (0, import_jsx_runtime42.jsx)("div", { ref: context.onContentChange, style: { minWidth: "100%", display: "table" }, children })
        }
      )
    ] });
  }
...
var ScrollAreaScrollbar = React211.forwardRef(
  (props, forwardedRef) => {
    ...
    return context.type === "hover" ? (0, import_jsx_runtime42.jsx)(ScrollAreaScrollbarHover, { ...scrollbarProps, ref: forwardedRef, forceMount }) : context.type === "scroll" ? (0, import_jsx_runtime42.jsx)(ScrollAreaScrollbarScroll, { ...scrollbarProps, ref: forwardedRef, forceMount }) : context.type === "auto" ? (0, import_jsx_runtime42.jsx)(ScrollAreaScrollbarAuto, { ...scrollbarProps, ref: forwardedRef, forceMount }) : context.type === "always" ? (0, import_jsx_runtime42.jsx)(ScrollAreaScrollbarVisible, { ...scrollbarProps, ref: forwardedRef }) : null;
  }
);
...
var ScrollAreaScrollbarHover = React211.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime42.jsx)(Presence, { present: forceMount || visible, children: (0, import_jsx_runtime42.jsx)(
...
var ScrollAreaScrollbarScroll = React211.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime42.jsx)(Presence, { present: forceMount || state !== "hidden", children: (0, import_jsx_runtime42.jsx)(
...
var ScrollAreaThumb = React211.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime42.jsx)(Presence, { present: forceMount || scrollbarContext.hasThumb, children: (0, import_jsx_runtime42.jsx)(ScrollAreaThumbImpl, { ref: forwardedRef, ...thumbProps }) });
  }
);
...
var ScrollAreaCorner = React211.forwardRef(
  (props, forwardedRef) => {
    ...
    return hasCorner ? (0, import_jsx_runtime42.jsx)(ScrollAreaCornerImpl, { ...props, ref: forwardedRef }) : null;
  }
);
...
var ScrollAreaCornerImpl = React211.forwardRef((props, forwardedRef) => {
  ...
  return hasSize ? (0, import_jsx_runtime42.jsx)(
    Primitive.div,
    {
      ...cornerProps,
      ref: forwardedRef,
...
function createSlot7(ownerName) {
  ...
  const Slot22 = React65.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    ...
    if (slottable) {
      ...
      const newChildren = childrenArray.map((child) => {
        if (child === slottable) {
          if (React65.Children.count(newElement) > 1) return React65.Children.only(null);
          return React65.isValidElement(newElement) ? newElement.props.children : null;
        } else {
          return child;
        }
      });
      return (0, import_jsx_runtime43.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React65.isValidElement(newElement) ? React65.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function createSlotClone7(ownerName) {
  const SlotClone = React65.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    if (React65.isValidElement(children)) {
      const childrenRef = getElementRef8(children);
      const props2 = mergeProps7(slotProps, children.props);
      if (children.type !== React65.Fragment) {
        props2.ref = forwardedRef ? composeRefs(forwardedRef, childrenRef) : childrenRef;
      }
      return React65.cloneElement(children, props2);
    }
    return React65.Children.count(children) > 1 ? React65.Children.only(null) : null;
  });
  SlotClone.displayName = `${ownerName}.SlotClone`;
  return SlotClone;
}
...
function isSlottable7(child) {
  return React65.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER7;
}
...
var Select = (props) => {
  ...
  const [trigger, setTrigger] = React66.useState(null);
  const [valueNode, setValueNode] = React66.useState(null);
  const [valueNodeHasChildren, setValueNodeHasChildren] = React66.useState(false);
  const direction = useDirection(dir);
  const [open, setOpen] = useControllableState({
    prop: openProp,
    defaultProp: defaultOpen ?? false,
  ...
  const triggerPointerDownPosRef = React66.useRef(null);
  const isFormControl2 = trigger ? form || !!trigger.closest("form") : true;
  const [nativeOptionsSet, setNativeOptionsSet] = React66.useState(/* @__PURE__ */ new Set());
  const nativeSelectKey = Array.from(nativeOptionsSet).map((option) => option.props.value).join(";");
  return (0, import_jsx_runtime44.jsx)(Root25, { ...popperScope, children: (0, import_jsx_runtime44.jsxs)(
    SelectProvider,
    {
      required,
      scope: __scopeSelect,
      ...
      disabled,
      children: [
        (0, import_jsx_runtime44.jsx)(Collection7.Provider, { scope: __scopeSelect, children: (0, import_jsx_runtime44.jsx)(
          SelectNativeOptionsProvider,
          {
            scope: props.__scopeSelect,
            onNativeOptionAdd: React66.useCallback((option) => {
              setNativeOptionsSet((prev) => new Set(prev).add(option));
            }, []),
            onNativeOptionRemove: React66.useCallback((option) => {
        ...
        isFormControl2 ? (0, import_jsx_runtime44.jsxs)(
          SelectBubbleInput,
          {
            "aria-hidden": true,
            required,
            ...
            form,
            children: [
              value === void 0 ? (0, import_jsx_runtime44.jsx)("option", { value: "" }) : null,
...
var SelectTrigger = React66.forwardRef(
  (props, forwardedRef) => {
    ...
    const pointerTypeRef = React66.useRef("touch");
    ...
    return (0, import_jsx_runtime44.jsx)(Anchor, { asChild: true, ...popperScope, children: (0, import_jsx_runtime44.jsx)(
      Primitive.button,
      {
        type: "button",
        role: "combobox",
...
var SelectValue = React66.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime44.jsx)(
      Primitive.span,
      {
        ...
        children: shouldShowPlaceholder(context.value) ? (0, import_jsx_runtime44.jsx)(import_jsx_runtime44.Fragment, { children: placeholder }) : children
      }
    );
  }
);
...
var SelectIcon = React66.forwardRef(
  (props, forwardedRef) => {
    const { __scopeSelect, children, ...iconProps } = props;
    return (0, import_jsx_runtime44.jsx)(Primitive.span, { "aria-hidden": true, ...iconProps, ref: forwardedRef, children: children || "▼" });
  }
);
SelectIcon.displayName = ICON_NAME;
var PORTAL_NAME10 = "SelectPortal";
var SelectPortal = (props) => {
  return (0, import_jsx_runtime44.jsx)(Portal, { asChild: true, ...props });
};
SelectPortal.displayName = PORTAL_NAME10;
var CONTENT_NAME13 = "SelectContent";
var SelectContent = React66.forwardRef(
  (props, forwardedRef) => {
    const context = useSelectContext(CONTENT_NAME13, props.__scopeSelect);
    const [fragment, setFragment] = React66.useState();
    useLayoutEffect2(() => {
    ...
    if (!context.open) {
      ...
      return frag ? ReactDOM5.createPortal(
        (0, import_jsx_runtime44.jsx)(SelectContentProvider, { scope: props.__scopeSelect, children: (0, import_jsx_runtime44.jsx)(Collection7.Slot, { scope: props.__scopeSelect, children: (0, import_jsx_runtime44.jsx)("div", { children: props.children }) }) }),
        frag
      ) : null;
    }
    return (0, import_jsx_runtime44.jsx)(SelectContentImpl, { ...props, ref: forwardedRef });
  }
);
...
var SelectContentImpl = React66.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeSelect,
    ...
    const [content, setContent] = React66.useState(null);
    const [viewport, setViewport] = React66.useState(null);
    const composedRefs = useComposedRefs(forwardedRef, (node) => setContent(node));
    const [selectedItem, setSelectedItem] = React66.useState(null);
    const [selectedItemText, setSelectedItemText] = React66.useState(
      null
    );
    const getItems = useCollection7(__scopeSelect);
    const [isPositioned, setIsPositioned] = React66.useState(false);
    const firstValidItemFoundRef = React66.useRef(false);
    React66.useEffect(() => {
      if (content) return hideOthers(content);
    }, [content]);
    useFocusGuards();
    const focusFirst6 = React66.useCallback(
      (candidates) => {
    ...
    const itemRefCallback = React66.useCallback(
      (node, value, disabled) => {
    ...
    const handleItemLeave = React66.useCallback(() => content == null ? void 0 : content.focus(), [content]);
    const itemTextRefCallback = React66.useCallback(
      (node, value, disabled) => {
        const isFirstValidItem = !firstValidItemFoundRef.current && !disabled;
        const isSelectedItem = context.value !== void 0 && context.value === value;
        if (isSelectedItem || isFirstValidItem) {
    ...
    return (0, import_jsx_runtime44.jsx)(
      SelectContentProvider,
      {
        ...
        isPositioned,
        searchRef,
        children: (0, import_jsx_runtime44.jsx)(Combination_default, { as: Slot11, allowPinchZoom: true, children: (0, import_jsx_runtime44.jsx)(
          FocusScope,
          {
            asChild: true,
...
var SelectItemAlignedPosition = React66.forwardRef((props, forwardedRef) => {
  const { __scopeSelect, onPlaced, ...popperProps } = props;
  const context = useSelectContext(CONTENT_NAME13, __scopeSelect);
  const contentContext = useSelectContentContext(CONTENT_NAME13, __scopeSelect);
  const [contentWrapper, setContentWrapper] = React66.useState(null);
  const [content, setContent] = React66.useState(null);
  const composedRefs = useComposedRefs(forwardedRef, (node) => setContent(node));
  const getItems = useCollection7(__scopeSelect);
  const shouldExpandOnScrollRef = React66.useRef(false);
  const shouldRepositionRef = React66.useRef(true);
  const { viewport, selectedItem, selectedItemText, focusSelectedItem } = contentContext;
  const position = React66.useCallback(() => {
  ...
  const [contentZIndex, setContentZIndex] = React66.useState();
  useLayoutEffect2(() => {
    if (content) setContentZIndex(window.getComputedStyle(content).zIndex);
  }, [content]);
  const handleScrollButtonChange = React66.useCallback(
    (node) => {
...
var SelectPopperPosition = React66.forwardRef((props, forwardedRef) => {
  const {
    __scopeSelect,
    align = "start",
...
var SelectViewport = React66.forwardRef(
  (props, forwardedRef) => {
    ...
    const prevScrollTopRef = React66.useRef(0);
    return (0, import_jsx_runtime44.jsxs)(import_jsx_runtime44.Fragment, { children: [
      ...
      (0, import_jsx_runtime44.jsx)(Collection7.Slot, { scope: __scopeSelect, children: (0, import_jsx_runtime44.jsx)(
        Primitive.div,
        {
...
var SelectGroup = React66.forwardRef(
  (props, forwardedRef) => {
    const { __scopeSelect, ...groupProps } = props;
    const groupId = useId();
    return (0, import_jsx_runtime44.jsx)(SelectGroupContextProvider, { scope: __scopeSelect, id: groupId, children: (0, import_jsx_runtime44.jsx)(Primitive.div, { role: "group", "aria-labelledby": groupId, ...groupProps, ref: forwardedRef }) });
  }
);
SelectGroup.displayName = GROUP_NAME6;
var LABEL_NAME6 = "SelectLabel";
var SelectLabel = React66.forwardRef(
  (props, forwardedRef) => {
    const { __scopeSelect, ...labelProps } = props;
    const groupContext = useSelectGroupContext(LABEL_NAME6, __scopeSelect);
    return (0, import_jsx_runtime44.jsx)(Primitive.div, { id: groupContext.id, ...labelProps, ref: forwardedRef });
  }
);
...
var SelectItem = React66.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeSelect,
      value,
    ...
    const [textValue, setTextValue] = React66.useState(textValueProp ?? "");
    ...
    return (0, import_jsx_runtime44.jsx)(
      SelectItemContextProvider,
      {
        ...
        textId,
        isSelected,
        onItemTextChange: React66.useCallback((node) => {
...
var SelectItemText = React66.forwardRef(
  (props, forwardedRef) => {
    ...
    const [itemTextNode, setItemTextNode] = React66.useState(null);
    const composedRefs = useComposedRefs(
      forwardedRef,
    ...
    const nativeOption = React66.useMemo(
      () => (0, import_jsx_runtime44.jsx)("option", { value: itemContext.value, disabled: itemContext.disabled, children: textContent }, itemContext.value),
    ...
    return (0, import_jsx_runtime44.jsxs)(import_jsx_runtime44.Fragment, { children: [
      (0, import_jsx_runtime44.jsx)(Primitive.span, { id: itemContext.textId, ...itemTextProps, ref: composedRefs }),
...
var SelectItemIndicator = React66.forwardRef(
  (props, forwardedRef) => {
    const { __scopeSelect, ...itemIndicatorProps } = props;
    const itemContext = useSelectItemContext(ITEM_INDICATOR_NAME2, __scopeSelect);
    return itemContext.isSelected ? (0, import_jsx_runtime44.jsx)(Primitive.span, { "aria-hidden": true, ...itemIndicatorProps, ref: forwardedRef }) : null;
  }
);
...
var SelectScrollUpButton = React66.forwardRef((props, forwardedRef) => {
  ...
  const [canScrollUp, setCanScrollUp] = React66.useState(false);
  ...
  return canScrollUp ? (0, import_jsx_runtime44.jsx)(
...
var SelectScrollDownButton = React66.forwardRef((props, forwardedRef) => {
  ...
  const [canScrollDown, setCanScrollDown] = React66.useState(false);
  const composedRefs = useComposedRefs(forwardedRef, viewportContext.onScrollButtonChange);
  useLayoutEffect2(() => {
    if (contentContext.viewport && contentContext.isPositioned) {
      let handleScroll22 = function() {
  ...
  return canScrollDown ? (0, import_jsx_runtime44.jsx)(
    SelectScrollButtonImpl,
    {
      ...props,
      ref: composedRefs,
...
var SelectScrollButtonImpl = React66.forwardRef((props, forwardedRef) => {
  const { __scopeSelect, onAutoScroll, ...scrollIndicatorProps } = props;
  const contentContext = useSelectContentContext("SelectScrollButton", __scopeSelect);
  const autoScrollTimerRef = React66.useRef(null);
  const getItems = useCollection7(__scopeSelect);
  const clearAutoScrollTimer = React66.useCallback(() => {
...
var SelectSeparator = React66.forwardRef(
  (props, forwardedRef) => {
    const { __scopeSelect, ...separatorProps } = props;
    return (0, import_jsx_runtime44.jsx)(Primitive.div, { "aria-hidden": true, ...separatorProps, ref: forwardedRef });
  }
);
SelectSeparator.displayName = SEPARATOR_NAME5;
var ARROW_NAME8 = "SelectArrow";
var SelectArrow = React66.forwardRef(
  (props, forwardedRef) => {
    ...
    return context.open && contentContext.position === "popper" ? (0, import_jsx_runtime44.jsx)(Arrow2, { ...popperScope, ...arrowProps, ref: forwardedRef }) : null;
  }
);
SelectArrow.displayName = ARROW_NAME8;
var BUBBLE_INPUT_NAME3 = "SelectBubbleInput";
var SelectBubbleInput = React66.forwardRef(
...
function useTypeaheadSearch(onSearchChange) {
  ...
  const searchRef = React66.useRef("");
  const timerRef = React66.useRef(0);
  const handleTypeaheadSearch = React66.useCallback(
    (key) => {
      const search = searchRef.current + key;
  ...
  const resetTypeahead = React66.useCallback(() => {
    searchRef.current = "";
    window.clearTimeout(timerRef.current);
  }, []);
  React66.useEffect(() => {
...
var Separator4 = React67.forwardRef((props, forwardedRef) => {
...
var Slider = React68.forwardRef(
  (props, forwardedRef) => {
    ...
    const thumbRefs = React68.useRef(/* @__PURE__ */ new Set());
    const valueIndexToChangeRef = React68.useRef(0);
    ...
    const valuesBeforeSlideStartRef = React68.useRef(values);
    ...
    return (0, import_jsx_runtime46.jsx)(
      SliderProvider,
      {
        ...
        orientation,
        form,
        children: (0, import_jsx_runtime46.jsx)(Collection8.Provider, { scope: props.__scopeSlider, children: (0, import_jsx_runtime46.jsx)(Collection8.Slot, { scope: props.__scopeSlider, children: (0, import_jsx_runtime46.jsx)(
          SliderOrientation,
          {
...
var SliderHorizontal = React68.forwardRef(
  (props, forwardedRef) => {
    const {
      min: min2,
      max: max2,
    ...
    const [slider, setSlider] = React68.useState(null);
    const composedRefs = useComposedRefs(forwardedRef, (node) => setSlider(node));
    const rectRef = React68.useRef(void 0);
    const direction = useDirection(dir);
    const isDirectionLTR = direction === "ltr";
...
var SliderVertical = React68.forwardRef(
  (props, forwardedRef) => {
    const {
      min: min2,
      max: max2,
...
var SliderImpl = React68.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeSlider,
      onSlideStart,
...
var SliderTrack = React68.forwardRef(
  (props, forwardedRef) => {
...
var SliderRange = React68.forwardRef(
  (props, forwardedRef) => {
...
var SliderThumb = React68.forwardRef(
  (props, forwardedRef) => {
    const getItems = useCollection8(props.__scopeSlider);
    const [thumb, setThumb] = React68.useState(null);
    const composedRefs = useComposedRefs(forwardedRef, (node) => setThumb(node));
    const index2 = React68.useMemo(
      () => thumb ? getItems().findIndex((item) => item.ref.current === thumb) : -1,
      [getItems, thumb]
    );
    return (0, import_jsx_runtime46.jsx)(SliderThumbImpl, { ...props, ref: composedRefs, index: index2 });
  }
);
var SliderThumbImpl = React68.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime46.jsxs)(
      "span",
      {
        ...
        children: [
          (0, import_jsx_runtime46.jsx)(Collection8.ItemSlot, { scope: props.__scopeSlider, children: (0, import_jsx_runtime46.jsx)(
            Primitive.span,
            {
              role: "slider",
          ...
          isFormControl2 && (0, import_jsx_runtime46.jsx)(
            SliderBubbleInput,
            {
...
var SliderBubbleInput = React68.forwardRef(
...
function createSlot8(ownerName) {
  ...
  const Slot22 = React69.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    ...
    if (slottable) {
      ...
      const newChildren = childrenArray.map((child) => {
        if (child === slottable) {
          if (React69.Children.count(newElement) > 1) return React69.Children.only(null);
          return React69.isValidElement(newElement) ? newElement.props.children : null;
        } else {
          return child;
        }
      });
      return (0, import_jsx_runtime47.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React69.isValidElement(newElement) ? React69.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function createSlotClone8(ownerName) {
  const SlotClone = React69.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    if (React69.isValidElement(children)) {
      const childrenRef = getElementRef9(children);
      const props2 = mergeProps8(slotProps, children.props);
      if (children.type !== React69.Fragment) {
        props2.ref = forwardedRef ? composeRefs(forwardedRef, childrenRef) : childrenRef;
      }
      return React69.cloneElement(children, props2);
    }
    return React69.Children.count(children) > 1 ? React69.Children.only(null) : null;
  });
  SlotClone.displayName = `${ownerName}.SlotClone`;
  return SlotClone;
}
...
function isSlottable8(child) {
  return React69.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER8;
}
...
var Switch = React70.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime48.jsxs)(SwitchProvider, { scope: __scopeSwitch, checked, disabled, children: [
...
var SwitchThumb = React70.forwardRef(
  (props, forwardedRef) => {
...
var SwitchBubbleInput = React70.forwardRef(
  ({
    __scopeSwitch,
    control,
    checked,
...
var TabsList = React71.forwardRef(
  (props, forwardedRef) => {
...
var TabsTrigger = React71.forwardRef(
  (props, forwardedRef) => {
...
var TabsContent = React71.forwardRef(
  (props, forwardedRef) => {
    ...
    const contentId = makeContentId2(context.baseId, value);
    const isSelected = value === context.value;
    const isMountAnimationPreventedRef = React71.useRef(isSelected);
    React71.useEffect(() => {
      const rAF = requestAnimationFrame(() => isMountAnimationPreventedRef.current = false);
      return () => cancelAnimationFrame(rAF);
    }, []);
    return (0, import_jsx_runtime49.jsx)(Presence, { present: forceMount || isSelected, children: ({ present }) => (0, import_jsx_runtime49.jsx)(
      Primitive.div,
      {
        "data-state": isSelected ? "active" : "inactive",
        "data-orientation": context.orientation,
...
var ToastProvider = (props) => {
  ...
  const [toastCount, setToastCount] = React72.useState(0);
  const isFocusedToastEscapeKeyDownRef = React72.useRef(false);
  const isClosePausedRef = React72.useRef(false);
  if (!label.trim()) {
    console.error(
      `Invalid prop \`label\` supplied to \`${PROVIDER_NAME}\`. Expected non-empty \`string\`.`
    );
  }
  return (0, import_jsx_runtime50.jsx)(Collection9.Provider, { scope: __scopeToast, children: (0, import_jsx_runtime50.jsx)(
    ToastProviderProvider,
    {
      ...
      viewport,
      onViewportChange: setViewport,
      onToastAdd: React72.useCallback(() => setToastCount((prevCount) => prevCount + 1), []),
      onToastRemove: React72.useCallback(() => setToastCount((prevCount) => prevCount - 1), []),
...
var ToastViewport = React72.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeToast,
    ...
    const headFocusProxyRef = React72.useRef(null);
    const tailFocusProxyRef = React72.useRef(null);
    ...
    const getSortedTabbableCandidates = React72.useCallback(
      ({ tabbingDirection }) => {
    ...
    return (0, import_jsx_runtime50.jsxs)(
      Branch,
      {
        ...
        children: [
          hasToasts && (0, import_jsx_runtime50.jsx)(
            FocusProxy,
            {
          ...
          (0, import_jsx_runtime50.jsx)(Collection9.Slot, { scope: __scopeToast, children: (0, import_jsx_runtime50.jsx)(Primitive.ol, { tabIndex: -1, ...viewportProps, ref: composedRefs }) }),
          hasToasts && (0, import_jsx_runtime50.jsx)(
            FocusProxy,
            {
...
var FocusProxy = React72.forwardRef(
  (props, forwardedRef) => {
...
var Toast = React72.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime50.jsx)(Presence, { present: forceMount || open, children: (0, import_jsx_runtime50.jsx)(
      ToastImpl,
      {
        open,
        ...toastProps,
...
var ToastImpl = React72.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeToast,
      type = "foreground",
    ...
    const [node, setNode] = React72.useState(null);
    const composedRefs = useComposedRefs(forwardedRef, (node2) => setNode(node2));
    const pointerStartRef = React72.useRef(null);
    const swipeDeltaRef = React72.useRef(null);
    const duration = durationProp || context.duration;
    const closeTimerStartTimeRef = React72.useRef(0);
    const closeTimerRemainingTimeRef = React72.useRef(duration);
    const closeTimerRef = React72.useRef(0);
    ...
    const startTimer = React72.useCallback(
      (duration2) => {
    ...
    const announceTextContent = React72.useMemo(() => {
      return node ? getAnnounceTextContent(node) : null;
    }, [node]);
    if (!context.viewport) return null;
    return (0, import_jsx_runtime50.jsxs)(import_jsx_runtime50.Fragment, { children: [
      announceTextContent && (0, import_jsx_runtime50.jsx)(
        ToastAnnounce,
        {
          __scopeToast,
          role: "status",
      ...
      (0, import_jsx_runtime50.jsx)(ToastInteractiveProvider, { scope: __scopeToast, onClose: handleClose, children: ReactDOM6.createPortal(
        (0, import_jsx_runtime50.jsx)(Collection9.ItemSlot, { scope: __scopeToast, children: (0, import_jsx_runtime50.jsx)(
          Root4,
          {
            asChild: true,
...
var ToastAnnounce = (props) => {
  ...
  const context = useToastProviderContext(TOAST_NAME, __scopeToast);
  const [renderAnnounceText, setRenderAnnounceText] = React72.useState(false);
  const [isAnnounced, setIsAnnounced] = React72.useState(false);
  useNextFrame(() => setRenderAnnounceText(true));
  React72.useEffect(() => {
    const timer = window.setTimeout(() => setIsAnnounced(true), 1e3);
    return () => window.clearTimeout(timer);
  }, []);
  return isAnnounced ? null : (0, import_jsx_runtime50.jsx)(Portal, { asChild: true, children: (0, import_jsx_runtime50.jsx)(VisuallyHidden, { ...announceProps, children: renderAnnounceText && (0, import_jsx_runtime50.jsxs)(import_jsx_runtime50.Fragment, { children: [
    context.label,
    " ",
    children
  ] }) }) });
...
var ToastTitle = React72.forwardRef(
  (props, forwardedRef) => {
    const { __scopeToast, ...titleProps } = props;
    return (0, import_jsx_runtime50.jsx)(Primitive.div, { ...titleProps, ref: forwardedRef });
  }
);
ToastTitle.displayName = TITLE_NAME3;
var DESCRIPTION_NAME3 = "ToastDescription";
var ToastDescription = React72.forwardRef(
  (props, forwardedRef) => {
    const { __scopeToast, ...descriptionProps } = props;
    return (0, import_jsx_runtime50.jsx)(Primitive.div, { ...descriptionProps, ref: forwardedRef });
  }
);
ToastDescription.displayName = DESCRIPTION_NAME3;
var ACTION_NAME2 = "ToastAction";
var ToastAction = React72.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime50.jsx)(ToastAnnounceExclude, { altText, asChild: true, children: (0, import_jsx_runtime50.jsx)(ToastClose, { ...actionProps, ref: forwardedRef }) });
  }
);
ToastAction.displayName = ACTION_NAME2;
var CLOSE_NAME3 = "ToastClose";
var ToastClose = React72.forwardRef(
  (props, forwardedRef) => {
    const { __scopeToast, ...closeProps } = props;
    const interactiveContext = useToastInteractiveContext(CLOSE_NAME3, __scopeToast);
    return (0, import_jsx_runtime50.jsx)(ToastAnnounceExclude, { asChild: true, children: (0, import_jsx_runtime50.jsx)(
      Primitive.button,
      {
        type: "button",
        ...closeProps,
...
var ToastAnnounceExclude = React72.forwardRef((props, forwardedRef) => {
...
var NAME8 = "Toggle";
var Toggle = React73.forwardRef((props, forwardedRef) => {
...
var ToggleGroup = import_react8.default.forwardRef((props, forwardedRef) => {
  ...
  if (type === "single") {
    ...
    return (0, import_jsx_runtime52.jsx)(ToggleGroupImplSingle, { ...singleProps, ref: forwardedRef });
  }
  if (type === "multiple") {
    const multipleProps = toggleGroupProps;
    return (0, import_jsx_runtime52.jsx)(ToggleGroupImplMultiple, { ...multipleProps, ref: forwardedRef });
  }
...
var ToggleGroupImplSingle = import_react8.default.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime52.jsx)(
    ToggleGroupValueProvider,
    {
      ...
      children: (0, import_jsx_runtime52.jsx)(ToggleGroupImpl, { ...toggleGroupSingleProps, ref: forwardedRef })
    }
  );
});
var ToggleGroupImplMultiple = import_react8.default.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime52.jsx)(
    ToggleGroupValueProvider,
    {
      ...
      children: (0, import_jsx_runtime52.jsx)(ToggleGroupImpl, { ...toggleGroupMultipleProps, ref: forwardedRef })
    }
  );
});
ToggleGroup.displayName = TOGGLE_GROUP_NAME;
...
var ToggleGroupImpl = import_react8.default.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime52.jsx)(ToggleGroupContext, { scope: __scopeToggleGroup, rovingFocus, disabled, children: rovingFocus ? (0, import_jsx_runtime52.jsx)(
      Root10,
      {
        asChild: true,
        ...rovingFocusGroupScope,
        ...
        dir: direction,
        loop,
        children: (0, import_jsx_runtime52.jsx)(Primitive.div, { ...commonProps, ref: forwardedRef })
      }
    ) : (0, import_jsx_runtime52.jsx)(Primitive.div, { ...commonProps, ref: forwardedRef }) });
  }
);
...
var ToggleGroupItem = import_react8.default.forwardRef(
  (props, forwardedRef) => {
    ...
    return context.rovingFocus ? (0, import_jsx_runtime52.jsx)(
      Item2,
      {
        asChild: true,
        ...rovingFocusGroupScope,
        ...
        active: pressed,
        ref,
        children: (0, import_jsx_runtime52.jsx)(ToggleGroupItemImpl, { ...commonProps, ref: forwardedRef })
      }
    ) : (0, import_jsx_runtime52.jsx)(ToggleGroupItemImpl, { ...commonProps, ref: forwardedRef });
  }
);
...
var Separator5 = React75.forwardRef((props, forwardedRef) => {
...
var Toolbar = React76.forwardRef(
  (props, forwardedRef) => {
    const { __scopeToolbar, orientation = "horizontal", dir, loop = true, ...toolbarProps } = props;
    const rovingFocusGroupScope = useRovingFocusGroupScope7(__scopeToolbar);
    const direction = useDirection(dir);
    return (0, import_jsx_runtime54.jsx)(ToolbarProvider, { scope: __scopeToolbar, orientation, dir: direction, children: (0, import_jsx_runtime54.jsx)(
      Root10,
      {
        asChild: true,
        ...rovingFocusGroupScope,
...
var ToolbarSeparator = React76.forwardRef(
  (props, forwardedRef) => {
...
var ToolbarButton = React76.forwardRef(
  (props, forwardedRef) => {
    const { __scopeToolbar, ...buttonProps } = props;
    const rovingFocusGroupScope = useRovingFocusGroupScope7(__scopeToolbar);
    return (0, import_jsx_runtime54.jsx)(Item2, { asChild: true, ...rovingFocusGroupScope, focusable: !props.disabled, children: (0, import_jsx_runtime54.jsx)(Primitive.button, { type: "button", ...buttonProps, ref: forwardedRef }) });
  }
);
ToolbarButton.displayName = BUTTON_NAME;
var LINK_NAME2 = "ToolbarLink";
var ToolbarLink = React76.forwardRef(
  (props, forwardedRef) => {
    const { __scopeToolbar, ...linkProps } = props;
    const rovingFocusGroupScope = useRovingFocusGroupScope7(__scopeToolbar);
    return (0, import_jsx_runtime54.jsx)(Item2, { asChild: true, ...rovingFocusGroupScope, focusable: true, children: (0, import_jsx_runtime54.jsx)(
      Primitive.a,
      {
        ...linkProps,
        ref: forwardedRef,
...
var ToolbarToggleGroup = React76.forwardRef(
  (props, forwardedRef) => {
...
var ToolbarToggleItem = React76.forwardRef(
  (props, forwardedRef) => {
    const { __scopeToolbar, ...toggleItemProps } = props;
    const toggleGroupScope = useToggleGroupScope(__scopeToolbar);
    const scope = { __scopeToolbar: props.__scopeToolbar };
    return (0, import_jsx_runtime54.jsx)(ToolbarButton, { asChild: true, ...scope, children: (0, import_jsx_runtime54.jsx)(Item26, { ...toggleGroupScope, ...toggleItemProps, ref: forwardedRef }) });
  }
);
...
function createSlot9(ownerName) {
  ...
  const Slot22 = React77.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    ...
    if (slottable) {
      ...
      const newChildren = childrenArray.map((child) => {
        if (child === slottable) {
          if (React77.Children.count(newElement) > 1) return React77.Children.only(null);
          return React77.isValidElement(newElement) ? newElement.props.children : null;
        } else {
          return child;
        }
      });
      return (0, import_jsx_runtime55.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React77.isValidElement(newElement) ? React77.cloneElement(newElement, void 0, newChildren) : null });
    }
    return (0, import_jsx_runtime55.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children });
  });
  Slot22.displayName = `${ownerName}.Slot`;
  return Slot22;
}
...
function createSlotClone9(ownerName) {
  const SlotClone = React77.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    if (React77.isValidElement(children)) {
      const childrenRef = getElementRef10(children);
      const props2 = mergeProps9(slotProps, children.props);
      if (children.type !== React77.Fragment) {
        props2.ref = forwardedRef ? composeRefs(forwardedRef, childrenRef) : childrenRef;
      }
      return React77.cloneElement(children, props2);
    }
    return React77.Children.count(children) > 1 ? React77.Children.only(null) : null;
  });
  SlotClone.displayName = `${ownerName}.SlotClone`;
  return SlotClone;
}
...
function createSlottable9(ownerName) {
  const Slottable22 = ({ children }) => {
    return (0, import_jsx_runtime55.jsx)(import_jsx_runtime55.Fragment, { children });
  };
  Slottable22.displayName = `${ownerName}.Slottable`;
...
function isSlottable9(child) {
  return React77.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER9;
}
...
var TooltipProvider = (props) => {
  ...
  const isOpenDelayedRef = React78.useRef(true);
  const isPointerInTransitRef = React78.useRef(false);
  const skipDelayTimerRef = React78.useRef(0);
  React78.useEffect(() => {
  ...
  return (0, import_jsx_runtime56.jsx)(
    TooltipProviderContextProvider,
    {
      ...
      isOpenDelayedRef,
      delayDuration,
      onOpen: React78.useCallback(() => {
        window.clearTimeout(skipDelayTimerRef.current);
        isOpenDelayedRef.current = false;
      }, []),
      onClose: React78.useCallback(() => {
        window.clearTimeout(skipDelayTimerRef.current);
        skipDelayTimerRef.current = window.setTimeout(
      ...
      onPointerInTransitChange: React78.useCallback((inTransit) => {
...
var Tooltip = (props) => {
  ...
  const [trigger, setTrigger] = React78.useState(null);
  const contentId = useId();
  const openTimerRef = React78.useRef(0);
  const disableHoverableContent = disableHoverableContentProp ?? providerContext.disableHoverableContent;
  const delayDuration = delayDurationProp ?? providerContext.delayDuration;
  const wasOpenDelayedRef = React78.useRef(false);
  const [open, setOpen] = useControllableState({
    prop: openProp,
    defaultProp: defaultOpen ?? false,
    onChange: (open2) => {
  ...
  const stateAttribute = React78.useMemo(() => {
    return open ? wasOpenDelayedRef.current ? "delayed-open" : "instant-open" : "closed";
  }, [open]);
  const handleOpen = React78.useCallback(() => {
    window.clearTimeout(openTimerRef.current);
  ...
  const handleDelayedOpen = React78.useCallback(() => {
    window.clearTimeout(openTimerRef.current);
    openTimerRef.current = window.setTimeout(() => {
  ...
  return (0, import_jsx_runtime56.jsx)(Root25, { ...popperScope, children: (0, import_jsx_runtime56.jsx)(
    TooltipContextProvider,
    {
      ...
      trigger,
      onTriggerChange: setTrigger,
      onTriggerEnter: React78.useCallback(() => {
        if (providerContext.isOpenDelayedRef.current) handleDelayedOpen();
        else handleOpen();
      }, [providerContext.isOpenDelayedRef, handleDelayedOpen, handleOpen]),
      onTriggerLeave: React78.useCallback(() => {
...
var TooltipTrigger = React78.forwardRef(
  (props, forwardedRef) => {
    ...
    const isPointerDownRef = React78.useRef(false);
    const hasPointerMoveOpenedRef = React78.useRef(false);
    const handlePointerUp = React78.useCallback(() => isPointerDownRef.current = false, []);
    React78.useEffect(() => {
      return () => document.removeEventListener("pointerup", handlePointerUp);
    }, [handlePointerUp]);
    return (0, import_jsx_runtime56.jsx)(Anchor, { asChild: true, ...popperScope, children: (0, import_jsx_runtime56.jsx)(
      Primitive.button,
      {
...
var TooltipPortal = (props) => {
  ...
  return (0, import_jsx_runtime56.jsx)(PortalProvider5, { scope: __scopeTooltip, forceMount, children: (0, import_jsx_runtime56.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime56.jsx)(Portal, { asChild: true, container, children }) }) });
};
TooltipPortal.displayName = PORTAL_NAME11;
var CONTENT_NAME15 = "TooltipContent";
var TooltipContent = React78.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime56.jsx)(Presence, { present: forceMount || context.open, children: context.disableHoverableContent ? (0, import_jsx_runtime56.jsx)(TooltipContentImpl, { side, ...contentProps, ref: forwardedRef }) : (0, import_jsx_runtime56.jsx)(TooltipContentHoverable, { side, ...contentProps, ref: forwardedRef }) });
  }
);
var TooltipContentHoverable = React78.forwardRef((props, forwardedRef) => {
  const context = useTooltipContext(CONTENT_NAME15, props.__scopeTooltip);
  const providerContext = useTooltipProviderContext(CONTENT_NAME15, props.__scopeTooltip);
  const ref = React78.useRef(null);
  const composedRefs = useComposedRefs(forwardedRef, ref);
  const [pointerGraceArea, setPointerGraceArea] = React78.useState(null);
  const { trigger, onClose } = context;
  const content = ref.current;
  const { onPointerInTransitChange } = providerContext;
  const handleRemoveGraceArea = React78.useCallback(() => {
    setPointerGraceArea(null);
    onPointerInTransitChange(false);
  }, [onPointerInTransitChange]);
  const handleCreateGraceArea = React78.useCallback(
    (event, hoverTarget) => {
  ...
  return (0, import_jsx_runtime56.jsx)(TooltipContentImpl, { ...props, ref: composedRefs });
});
var [VisuallyHiddenContentContextProvider, useVisuallyHiddenContentContext] = createTooltipContext(TOOLTIP_NAME, { isInside: false });
var Slottable11 = createSlottable9("TooltipContent");
var TooltipContentImpl = React78.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeTooltip,
      children,
    ...
    return (0, import_jsx_runtime56.jsx)(
      DismissableLayer,
      {
        ...
        onFocusOutside: (event) => event.preventDefault(),
        onDismiss: onClose,
        children: (0, import_jsx_runtime56.jsxs)(
          Content4,
          {
            "data-state": context.stateAttribute,
            ...popperScope,
            ...
            children: [
              (0, import_jsx_runtime56.jsx)(Slottable11, { children }),
              (0, import_jsx_runtime56.jsx)(VisuallyHiddenContentContextProvider, { scope: __scopeTooltip, isInside: true, children: (0, import_jsx_runtime56.jsx)(Root2, { id: context.contentId, role: "tooltip", children: ariaLabel || children }) })
            ]
          }
        )
      }
...
var TooltipArrow = React78.forwardRef(
  (props, forwardedRef) => {
    ...
    return visuallyHiddenContentContext.isInside ? null : (0, import_jsx_runtime56.jsx)(Arrow2, { ...popperScope, ...arrowProps, ref: forwardedRef });
  }
);
